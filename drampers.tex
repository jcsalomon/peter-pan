...
% Full names &c.
\Character{PETER PAN}{peterpan}
\Character{PAN}{pan}
\Character{TINKER BELL}{tinkerbell}

\Character{MR.\@ {\normalfont and} MRS.\@ DARLING}{mrandmrsdarling}

\Character{JAS.\@ HOOK}{jashook}
\Character{CAPTAIN JAS.\@ HOOK}{captjashook}
\Character{BLACK*.* MURPHY}{blackmurphy}
\Character{BILL JUKES}{billjukes}
\Character{GENTLEMAN STARKEY}{gentlemanstarkey}
\Character{SKYLIGHTS}{skylights}
\Character{FLINT}{flint}

\Character{GREAT BIG LITTLE PANTHER}{greatbiglittlepanther}
