...
\direct{WENDY <i>gives way to ecstasy.}
...
\direct{MICHAEL <i>emerges from the bathroom in</i> JOHN's <i>old pyjamas and giving his face a last wipe with the towel.}
...
\direct{With bent head</i> JOHN <i>follows</i> NANA <i>into the bathroom. \mrdarling swells.}
...
\direct{Unfortunately</i> NANA <i>has come from the bathroom for a sponge and she collides with his trousers<sub>)</sub> the first pair</i> <i>he has ever had with braid on them.}

\mrdarlingspeaks
Mary, it is too bad; just look at this; covered with hairs. Clumsy, clumsy!</p>

\direct{NANA <i>goes, a drooping figure.}

\mrsdarlingspeaks
Let me brush you, dear.</p>

\direct{Once more she is successful. They are now by the fire, and</i> MICHAEL <i>is in bed doing idiotic things with a teddy bear.}
...
\mrsdarlingspeaks \direct{making sure that</i> MICHAEL <i>does not hear}¤
...
\direct{This intimate scene is broken by the return of</i> NANA <i>with a bottle in her mouth.}
...
\direct{WENDY, <i>who has appeared in her nightgown, hears this and believes.}
...
\direct{She is gone before he can stop her. He turns for help to</i> JOHN, <i>who has come from the bathroom attired for bed.}
...
\direct{A spasm of ill-will to</i> JOHN <i>cuts through \mrdarling, and is gone.</i> WENDY <i>returns panting.}
...
\direct{He is now at the foot of</i> MICHAEL's <i>bed,</i> NANA <i>is by its side, holding the medicine spoon insinuatingly in her mouth.}

<p>WENDY \direct{proudly, as she pours out \mrdarling's medicine}¤
...
\direct{MICHAEL <i>partakes, but \mrdarling resorts to hanky-panky.}

<p>JOHN. Father hasn't taken his!</p>

\direct{MICHAEL <i>howls.}
...
\direct{NANA <i>shakes her head sadly over him, and goes into the bathroom. They are all looking as if they did not admire him, and nothing so dashes a temperamental man.}
...
\direct{The children break into lamentation. He gives his wife an imploring look; he is begging for one smile, but does not get it. In consequence he goes from bad to worse.}

\mrdarlingspeaks
It was only a joke. Much good my wearing myself to the bone trying to be funny in this house.</p>

<p>WENDY \direct{on her knees by the kennel}¤
Father, Nana is crying.</p>

\mrdarlingspeaks
Coddle her; nobody coddles me. Oh dear no. I am only the bread-winner, why should I be coddled? Why, why, why?</p>
...
\direct{NANA <i>supplicates him.}
In vain, in vain, the proper place for you is the yard, and there you go to be tied up this instant.</p>

\direct{NANA <i>again retreats into the kennel, and the children add their prayers to hers.}
...
\mrsdarlingspeaks
All quite quiet and still. Oh, how I wish I was not going out to dinner to-night.</p>

<p>MICHAEL. Can anything harm us, mother, after the night-lights are lit?</p>

\mrsdarlingspeaks
Nothing precious. They are the eyes amother leaves behind her to guard her children.</p>

\direct{Nevertheless we may be sure she means to tell</i> LIZA, <i>the little maid, to look in on them frequently till she comes home. She goes from bed to bed, after her custom, tucking them in and crooning a lullaby.}
...
\direct{She leaps out of bed to put her arms round him, but he draws back; he does not know why, but he knows he must draw back.}
...
\direct{With one haughty leap she is again in bed with the sheet over her face. Popping on to the end of the bed the artful one appeals.}
...
<p>PETER \direct{to whom this statement recalls a forgotten friend}¤)
...
<p>PETER \direct{flitting about in search}¤
...
<p>PETER. \direct{with shameless glee}¤
Wendy, I believe I shut her up in that drawer!</p>

\direct{He releases</i> TINK, <i>who darts about in a fury using language it is perhaps as well we don't understand.}
...
\direct{To show that she can do even this</i> TINK <i>pauses between two ticks of the cuckoo clock.}
...
\direct{They have reached a chair,</i> WENDY <i>in the ordinary way and</i> PETER <i>through a hole in the back.}
...
\direct{PETER, <i>for the first time, has a good look at</i> JOHN. <i>He then neatly tumbles him out of bed.}
...
<p>PETER \direct{only half placated}¤
What is that?</p>
...
\direct{TINK <i>speaks. She is in the jug again.}
...
<p>WENDY \direct{playing rum-turn on</i> JOHN}¤
...
\direct{The sleepers are at once as awake as their father's razor;but before a question can be asked</i> NANA's <i>bark is heard.}

<p>JOHN. Out with the light, quick, hide!</p>

\direct{When the maid</i> LIZA, <i>who is so small that when she says she will never see ten again one can scarcely believe her, enters with a firm hand on the troubled</i> NANA's <i>chain the room is in comparative darkness.}

<p>LIZA. There, you suspicious brute, they are perfectly safe, aren't they? Every one of the little angels sound asleep in bed. Listen to their gentle breathing.
\direct{NANA's <i>sense of smell here helps to her undoing instead of hindering it. She knows that they are in the room.</i> MICHAEL, <i>who is behind the window curtain, is so encouraged by</i> LIZA's <i>last remark that he breathes too loudly.</i> NANA <i>knows that kind of breathing and tries to break from her keeper's control.
No more of it, Nana.
...
\direct{The unhappy</i> NANA is <i>led away. The children emerge exulting from their various hiding-places. In their brief absence from the scene strange things have been done to them; but it is not for us to reveal a mysterious secret of the stage. They look just the same.}
...
\direct{It looks so easy that they try it first from the floor <b>and</b>then from their beds, without encouraging results.}
...
\direct{The gallant</i> MICHAEL <i>is the first to let go, and is borne across the room.}

<p>MICHAEL \direct{with a yell that should have disturbed</i> LIZA}¤
I flewed!</p>

\direct{JOHN <i>lets go, and meets</i> WENDY <i>near the bathroom door though they had both aimed in an opposite direction.}
...
\direct{They are not nearly so elegant in the air as</i> PETER, <i>but their heads have bumped the ceiling, and there is nothing more delicious than that.}
...
\direct{TINK <i>does not like it. She darts at their hair. From down below in the street the lighted window must present an unwonted spectacle: the shadows of children revolving in the room like a merry-go-round.
This is perhaps what {\namefont MR.} and \mrsdarling see as they come hurrying home from the party, brought by</i> NANA <i>who, you may be sure, has broken her chain.</i> PETER's <i>accomplice, the little star, has seen them coming, and again the window blows open.}

<p>PETER \direct{as if he had heard the star whisper 'Cave'}¤
Now come!</p>

\direct{Breaking the circle he flies out of the window over the trees of the square and over the house-tops, and the others follow like a flight of birds. The broken-hearted father and mother arrive just in time to get a nip from TINK as she too sets out for the Never Land.}
